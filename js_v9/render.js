...
function renderBeginningText() {
	...
	renderText((trueCanvas.width)/2 - 85 * settings.scale, (trueCanvas.height)/2 - 35 - 169 * settings.scale, 20, '#2c3e50', 'Rotación:', 'px Roboto');
	...
	renderText((trueCanvas.width)/2 + 1.5 * settings.scale, (trueCanvas.height)/2 - 35 - 125 * settings.scale, 20, '#2c3e50', 'Gire el hexágono para hacer combos de 3(tres) o más bloques tocandose', 'px Roboto');
	...
	renderText((trueCanvas.width)/2 + 1.5 * settings.scale, (trueCanvas.height)/2 - 35 - 75 * settings.scale, 20, '#2c3e50', 'No dejes que los bloques se acumulen fuera del hexágono gris', 'px Roboto');
	renderText((trueCanvas.width)/2 + 1.5 * settings.scale, (trueCanvas.height)/2 - 35 - 50 * settings.scale, 20, '#2c3e50', (settings.platform == 'mobile' ? 'Tap the middle to toggle 2x speed' : 'Sostenga presionada la flecha hacia abajo para aumentar la velocidad de 2x'), 'px Roboto');
}
